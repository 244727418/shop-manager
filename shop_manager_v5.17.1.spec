...
a.binaries = [
    ...
    if item[0].lower() not in {
        r'pyqt5\qt5\plugins\platforms\qwebgl.dll',
        r'pyqt5\qt5\bin\qt5quick.dll',
        r'pyqt5\qt5\bin\qt5qml.dll',
        r'pyqt5\qt5\bin\qt5qmlmodels.dll',
        r'pyqt5\qt5\bin\qt5websockets.dll',
    }
]
pyz = PYZ(a.pure)
